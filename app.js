...
class Bd {
	...
	recuperarTodosRegistros() {
		...
		var total = despesas.reduce(getTotal, 0);
		function getTotal(total, item) {
 		return total + (parseFloat(item.valor.replace(',','.')));
		}
	...
	pesquisar(despesa){
		...
		var total = despesasFiltradas.reduce(getTotal, 0);
		function getTotal(total, item) {
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
	...
	*/
	...
	linha.insertCell(2).innerHTML = '<strong>Valor Total</strong>'
